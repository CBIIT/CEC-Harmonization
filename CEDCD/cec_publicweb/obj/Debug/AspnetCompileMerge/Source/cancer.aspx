<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="cancer.aspx.cs" Inherits="cec_publicweb.cancer" %>
...
<form id="mainForm" runat="server">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-4 filterCol">
                  <div id="gender_area" class="filter-component" runat="server">
                    <h3>Gender</h3>
                      <cec:CECGenderCheckBoxList ID="gender" runat="server" />
                    <!--<ul>
                      <li>
                        <label for="cb_gmale">
                ...
                <div class="col-sm-4 filterCol">
                  <h3>Cancer Type</h3>
                  <cec:CECCancerCheckBoxList ID="select_cancer" runat="server" ShowAllCancerOption="true" />
                </div>
              ...
              <div class="row">
                <div id="submitButtonContainer" class="col-sm-3 col-sm-offset-9">
                  ...
                  <asp:Button CssClass="btn btn-primary bttn_submit" ID="submitBtn" runat="server" Text="Submit" OnClick="Submit_Clicked" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="cedcd-cohorts-inner" class="col-md-12">
            <div class="table-inner col-md-12">
              ...
              <div class="cedcd-table">
                <asp:GridView ID="cancerGridView" runat="server" ShowHeaderWhenEmpty="true" ClientIDMode="Static" AllowSorting="false" 
                            EmptyDataText="No Results"
                            onrowdatabound="cancerGridView_RowDataBound">
  ...
  <script type="text/javascript">
          $(document).ready(function () {
              ...
              if ($('#cancerGridView').attr('has_results')) {
                  $('html, body').animate({
                      scrollTop: $("#cancerGridView").offset().top
                  }, 500);
              }
          });
          ...
          function enableSubmit() {
              if ($('#cancer_options_list input:checked').length > 0 && $('#cohort_list_container input:checked').length > 0 && $('#gender_area input:checked').length > 0) {
  ...
  <script type="text/javascript">
	...
	tour.addStep({
		...
		content: 'Starting with Gender, <b>specify one or more</b> participant characteristics from each category and select <b>cohorts,</b> then select <b>Submit</b> to proceed to a table of cancers across the selected cohorts.',
		placement: "top"
	});
</script>
</form>
