...
class Cancer extends Component {
	...
	componentDidMount(){
		...
		fetch('/api/cohort/details/cancer',{
			method: "POST",
  ...
  render() {
    ...
    let params = {};
  	...
  	params.config.sideHeader = [48,36,36,36,112,36,36,48,36,36,36,36,36,36,112,36,36,36,55,112,36,48,36,36,112,36,36,36,48,36,36,36,112];
    return (
    <div>
