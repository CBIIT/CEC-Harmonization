    ...
    <div id="forum-table-<?php print $table_info->tid; ?>">
      <table class="forum-table forum-table-forums">
        <thead class="forum-header">
          <tr>
            <!--<th scope="col" class="forum-icon">&nbsp;</th>-->
            <th scope="col" class="forum-name"><?php print t('Discussion(s)'); ?></th>
            <th scope="col" class="forum-topics"><?php print t('Topic(s)'); ?></th>
            <th scope="col" class="forum-posts"><?php print t('Post(s)'); ?></th>
            <th scope="col" class="forum-last-post"><?php print t('Last post'); ?></th>
          </tr>
        </thead>
