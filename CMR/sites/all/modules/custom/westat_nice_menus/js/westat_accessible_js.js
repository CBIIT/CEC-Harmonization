...
(function ($) {
  ...
  Drupal.behaviors.niceMenus = {
	...
	$('ul.westat-nice-menu:not(.westat-nice-menus-processed)').addClass('westat-nice-menus-processed');
	var menu1 = new menubar('menubar', false);
	$('#block-westat-nice-menus-2 .menubar').mouseleave(function(){
		$(this).parents('.block').find('h2 a').attr('aria-expanded', 'false');
		$(this).parents('.block').find('h2:not(.collapsiblockCollapsed)').addClass('collapsiblockCollapsed');
		$(this).parents('.block-content')
			.attr('aria-hidden', 'true')
			.hide();
	});
	//$('#block-westat-nice-menus-2 h2 a').focus(function(){
	//	$(this).attr('aria-expanded', 'true');
	//	$(this).parents('.block').find('.block-content')
	//		.attr('aria-hidden', 'false')
	//		.css({'display':'block'});
	//	//$(this).parents('h2.collapsiblockCollapsed').removeClass('collapsiblockCollapsed');
	//	
	//});
    }
  };
